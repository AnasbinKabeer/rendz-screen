...
export default function Page() {
  ...
  useEffect(() => {
    ...
    gsap.to(cardRef.current, {
      ...
      yoyo: true,
      repeat: -1,
      repeatDelay: 10,   // pause for 5s before repeating
      ease: "power1.inOut",
      delay: 10,
    });
  ...
  useEffect(() => {
    ...
    tl.fromTo(
      ...
      .to(orderRef.current, {
        ...
        y: -50,
        duration: 0.8,
        delay: 1, // keep visible for a while
        ease: "power2.inOut",
      })
      // Title + Category in
      .to(titleRef.current, {
  ...
  useEffect(() => {
    ...
    gsap.to(lettersRef.current, {
      ...
      ease: "back.out(1.7)",
      onComplete: () => {
        // 2️⃣ Subtle bounce / scale pulse after popup
        gsap.to(lettersRef.current, {
          scale: 1.05,
          duration: 0.3,
          ease: "power1.inOut",
    ...
    // Animate campus name (fade-up after letters)
    ...
    <div className="relative w-full h-screen flex flex-col justify-center items-center overflow-hidden bg-green-600">
      ...
      {data?.code && (
        <>
          {/* Big Code Display */}
          {showcode && (
            <div className="relative flex items-center w-200 h-screen justify-center">

              {/* Center Circle */}
              <div className="relative z-10 flex items-center justify-center w-full h-full  bg-blue-500">
                <h1 className="text-[140px] sm:text-[200px] md:text-[260px] font-extrabold text-white tracking-tight">
                  {data?.code}
                </h1>
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 px-8">
                ...
                <div className="flex flex-col leading-tight">
                  <p className="text-3xl sm:text-4xl font-semibold text-gray-800">
                    {data.selectedProgram.split("|")[0].trim()}               </p>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            ...
            <div className="flex flex-col items-center justify-center text-center mt-12">
              <div className="text-[15vh] leading-[160px] text-center tracking-wide 
                        text-gray-100 drop-shadow-md font-black font-bebas">
